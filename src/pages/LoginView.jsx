...
export default function LoginView() {
  ...
  return (
    <div style={{ height: '100vh', width: '100vw', display: 'flex', alignItems: 'center', justifyContent: 'center', background: C.bg0 }}>
      <div style={{ width: '100%', maxWidth: 340, padding: '0 20px' }}>
        ...
        <div style={{ background: C.bg1, border: `1px solid ${C.border}`, borderRadius: 8, padding: '24px 24px 20px' }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <div>
              <label style={{ display: 'block', fontSize: 9, fontWeight: 600, color: C.text2, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 4 }}>Correo</label>
              <input
                type="email" value={email} onChange={e => { setEmail(e.target.value); setError(''); }}
                placeholder="usuario@equilybrio.com" autoComplete="email" autoFocus
                style={{ ...iS, width: '100%', borderColor: error ? 'var(--red)' : 'var(--border)', transition: 'border-color 0.15s' }}
            ...
            <div>
              <label style={{ display: 'block', fontSize: 9, fontWeight: 600, color: C.text2, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 4 }}>Contraseña</label>
              <input
            ...
            <button
              ...
              style={{ marginTop: 4, width: '100%', padding: '7px 0', borderRadius: 4, border: 'none', background: loading || !email || !password ? C.bg3 : 'var(--accent)', color: loading || !email || !password ? C.text2 : '#fff', fontSize: 12, fontWeight: 500, cursor: loading || !email || !password ? 'default' : 'pointer', transition: 'background 0.15s, color 0.15s', letterSpacing: '0.01em' }}
            >
